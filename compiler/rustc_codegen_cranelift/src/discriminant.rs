...
pub(crate) fn codegen_get_discriminant<'tcx>(
    ...
    codegen_get_discriminant_either(fx, value, dest_layout, true)
}

pub(crate) fn codegen_get_relative_discriminant<'tcx>(
    fx: &mut FunctionCx<'_, '_, 'tcx>,
    value: CValue<'tcx>,
    dest_layout: TyAndLayout<'tcx>,
) -> CValue<'tcx> {
    codegen_get_discriminant_either(fx, value, dest_layout, false)
}

fn codegen_get_discriminant_either<'tcx>(
    fx: &mut FunctionCx<'_, '_, 'tcx>,
    value: CValue<'tcx>,
    dest_layout: TyAndLayout<'tcx>,
